...
<div
	class="flex flex-col sm:flex-row justify-between shadow-md rounded-md bg-gray my-4 px-8 pt-10 pb-7"
>
	...
	<div class="flex-none flex flex-col-reverse sm:flex-col justify-items-stretch basis-40">
		<button
			...
			>Add to Anki</button
		>
		<div class="flex flex-col-reverse sm:flex-col sm:divide-y divide-blue">
			...
			{#if lemma.audio.length != 0}
				<div class="flex flex-row pt-4">
					...
					<p class="m-1 text-dark-gray my-auto text-sm leading-5">Listen to pronunciation</p>
